...
const NewTask = ({data}) => {
    console.log(data)
  return (
    <div className='w-80 bg-blue-500 h-35 m-5 rounded-2xl hover:bg-black hover:scale-105 border-2 border-black hover:border-emerald-500 lg:w-[90%] md:w-120 sm:w-120'>
        ...
        <div className="ml-55 -mt-17 lg:ml-160 sm:ml-80 lg:-mt-10">
            <button className='bg-blue-900 w-20 h-7 rounded-full transition transform active:scale-90 lg:h-10 lg:w-40'>New TASK</button>
        </div>
    </div>
  )
}
