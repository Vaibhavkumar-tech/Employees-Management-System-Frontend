...
const AcceptTask = ({data}) => {
  ...
  return (
    <div className='w-70 bg-yellow-500 h-35 m-5 rounded-2xl hover:bg-black hover:scale-105 border-2 border-black hover:border-emerald-500 lg:w-[90%] md:w-120 sm:w-120'>
